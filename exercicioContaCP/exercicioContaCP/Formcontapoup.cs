...
{
    public partial class Formcontapoup : Form
    {
        Conta conta;
        public Formcontapoup()
        {
            InitializeComponent();
            conta = new Conta();
        }
        ...
        private void txtNConta_TextChanged(object sender, EventArgs e)
        {
        ...
        private void Formcontapoup_Load(object sender, EventArgs e)
        {
